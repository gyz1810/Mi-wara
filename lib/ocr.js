...
// La API solo acepta estos formatos. El iPhone entrega HEIC, asi que hay que convertir
// antes de llegar aca: en la app lo hace el canvas, en el Atajo la accion "Convertir imagen".
export const FORMATOS_ACEPTADOS = ["image/jpeg", "image/png", "image/gif", "image/webp"];
...
// Manda las imagenes a Claude y devuelve el JSON ya parseado.
